...
const BasicCoffee = () => {
  ...
  const handleBookingSubmit = (e) => {
    e.preventDefault();
    alert('Booking submitted for Basic Coffee & Market Tour! We\'ll contact you soon.');
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex justify-center">
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                      ...
                      <input type="hidden" name="item_name" value="Basic Coffee & Market Tour - $35 per person" />
                      <input type="hidden" name="currency_code" value="USD" />
                      <input type="hidden" name="amount" value="35.00" />
                      <input type="hidden" name="return" value="https://saigonese-hangout.com/booking/success" />
                      <input type="hidden" name="cancel_return" value="https://saigonese-hangout.com/booking/coffee/basic" />
